...
CREATE TABLE SNGWALLET_ENTITY(/*BILLETERA DE LA ENTIDAD*/
	...
	SSMONEYSNG		INT DEFAULT 0 NOT NULL																		--DINERO
...
CREATE TABLE SNGCARD_WALLET(/*TABLA TARJETA EN LA BILLETERA*/
	...
	SSDESCCARD		VARCHAR(100) NOT NULL,																		--NOMBRE DE LA TARJETA
	SSNUMBERCARD	VARCHAR(255) NOT NULL,																		--NUMERO DE LA TARJETA
...
CREATE TABLE SNGENTITY(/*TABLA DE LA ENTIDAD USARIO | EMPLEADO | EMPRESA | PROVEEDOR | OTROS*/
	...
	SNGDATEBIR		TIMESTAMP,																					--FECHA DE NACIMIENTO O DE CREACIÓN DE LA ENTIDAD
...
CREATE TABLE SAMPURPAY(/*CANTIDAD DE PAGOS PARA REALIZAR LA COMPRA*/
	...
	CONSTRAINT LABCAT_ADDRESS_WAREH FOREIGN KEY (IDLABCAT) REFERENCES SNGLABEL_CATEG(IDLABCAT)					--FK TABLA CATEGORIA ETIQUETA
	--CANTIDAD QUE PAGA POR ESTE TIPO DE PAGO MONEY (SI ES EN DOLARES, PREVIAMENTE SE DEBE REALIZAR LA CONVERCIÓN A PESO CHILENO Y SOLO SE PUEDE PAGAR EL TOTAL SI ES EN DOLARES, UN SOLO PAGO)
);
